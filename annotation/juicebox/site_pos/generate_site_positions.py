...
genome=sys.argv[2]
if genome == 'hg19':
  filename='/mnt/raid1/IMPORT/Illumina/bowtie_indexes/hg19.fa'
elif genome == 'mm9':
  filename='/mnt/raid1/IMPORT/Illumina/bowtie_indexes/mm9.fa'
elif genome == 'mm10':
  filename='/mnt/raid1/IMPORT/Illumina/bowtie_indexes/mm10.fa'
elif genome == 'hg18':
  filename='/mnt/raid1/IMPORT/Illumina/bowtie_indexes/hg18.fa'
elif len(sys.argv) == 4:
  filename=sys.argv[3]
else:
  print 'Usage: %s <restriction enzyme> <genome> [location]' % (sys.argv[0])
